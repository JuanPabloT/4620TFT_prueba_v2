...
# 88 "D:\MPlab\pic\include\c90\stdio.h"
...
# 30 "D:\MPlab\pic\include\c90\math.h"
...
# 7 "D:\MPlab\pic\include\c90\stdlib.h"
...
# 14 "D:\MPlab\pic\include\c90\string.h"
...
fillScreen(0x0000);
n = (((_width) < (_height)) ? (_width) : (_height));
...
fillScreen(0x0000);
w = (((_width) < (_height)) ? (_width) : (_height));
...
for (i = (((_width) < (_height)) ? (_width) : (_height)); i > 20; i -= 6) {
i2 = i / 2;
